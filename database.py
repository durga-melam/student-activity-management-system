...
def init_db():
    ...
    # Reset Devakoti Google Internship to original authentic 2025-05-12 date
    cursor.execute("UPDATE activities SET event_date = '2025-05-12', to_date = '2025-08-01' WHERE regd_no = '22B01A1231' AND category = 'Internship'")
    cursor.execute("DELETE FROM activities WHERE regd_no = '22B91A1201'")
    conn.commit()
    conn.close()
